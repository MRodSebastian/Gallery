...
public protocol GalleryControllerDelegate{
...
public class GalleryController: UIViewController, PermissionControllerDelegate {
    ...
    public var delegate: GalleryControllerDelegate?
    
    public let cart = Cart()
    
    deinit{
        debugPrint("deinit library GalleryController")
    }
    ...
    func makeImagesController() -> ImagesController {
        ...
        controller.title = NSLocalizedString("photos", comment: "").uppercased()
    ...
    func makeCameraController() -> CameraController {
        ...
        controller.title = NSLocalizedString("camera", comment: "").uppercased()
    ...
    func makeVideosController() -> VideosController {
        ...
        controller.title = NSLocalizedString("videos", comment: "").uppercased()
