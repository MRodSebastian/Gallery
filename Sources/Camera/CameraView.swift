...
class CameraView: UIView, UIGestureRecognizerDelegate {
  ...
  func makeFlashButton() -> TripleButton {
    let states: [TripleButton.ButtonState] = [
      TripleButton.ButtonState(title: NSLocalizedString("off", comment: ""), image: UIImage()),
      TripleButton.ButtonState(title: NSLocalizedString("on", comment: ""), image: UIImage()),
      TripleButton.ButtonState(title: NSLocalizedString("auto", comment: ""), image: UIImage())
    ]
  ...
  func makeDoneButton() -> UIButton {
    ...
    button.setTitle(NSLocalizedString("off", comment: ""), for: UIControl.State())
